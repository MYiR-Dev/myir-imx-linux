...
struct es8389_private *es8389_data;
struct snd_soc_component *es8389_codec;
...
static void es8389_state_delay_work(struct work_struct *work)
{
	...
	if (state == ES8389_STATE_STANDBY){
		...
		regmap_write(es8389->regmap, ES8389_DAC_RAMP_REG49, 0x00);

		regmap_write(es8389->regmap, ES8389_CLK_OFF2_REG0E, 0x50);
		regmap_write(es8389->regmap, ES8389_ADC_MODE_REG23, 0x10);
		regmap_write(es8389->regmap, ES8389_ADC_HPF1_REG24, 0xE6);
		regmap_write(es8389->regmap, ES8389_ALC_ON_REG2B, 0x00);
		regmap_write(es8389->regmap, ES8389_DAC_MIX_REG44, 0x0C);
		regmap_write(es8389->regmap, ES8389_ANA_VSEL_REG62, 0x88);
		regmap_write(es8389->regmap, ES8389_MOD_SW2_REG70, 0x88);
		regmap_write(es8389->regmap, ES8389_MOD_SW3_REG71, 0x88);
		
		regmap_update_bits(es8389->regmap, ES8389_DMIC_EN_REG6D, 0x3F, 0x3C);
		regmap_write(es8389->regmap, ES8389_ANA_CTL1_REG61, 0xCF);
		regmap_write(es8389->regmap, ES8389_HPSW_REG69, 0x23);
	}
	regmap_write(es8389->regmap, ES8389_ADC_EN_REG64, 0x9A);
	regmap_write(es8389->regmap, ES8389_PGA_SW_REG6E, 0xA4);
	regmap_write(es8389->regmap, ES8389_MIC1_GAIN_REG72, 0x58);
	regmap_write(es8389->regmap, ES8389_MIC2_GAIN_REG73, 0x00);
	regmap_write(es8389->regmap, ES8389_ADCL_VOL_REG27, 0xC5);
	regmap_write(es8389->regmap, ES8389_ADCR_VOL_REG28, 0x00);
	regmap_update_bits(es8389->regmap, ES8389_ADC_MUTE_REG2F, 0x30, 0x10);
	regmap_update_bits(es8389->regmap, ES8389_ALC_TARGET_REG2C, 0xE0, 0x20);
	regmap_update_bits(es8389->regmap, ES8389_ALC_GAIN_REG2D, 0xE0, 0xE0);
	regmap_update_bits(es8389->regmap, ES8389_ADC_REG20, 0x03, 0x01);
	regmap_update_bits(es8389->regmap, ES8389_DAC_REG40, 0x03, 0x00);
...
static int es8389_probe(struct snd_soc_component *codec)
{
	...
	regmap_write(es8389->regmap, ES8389_ANA_VSEL_REG62, 0xFF);
	regmap_write(es8389->regmap, ES8389_ANA_CTL2_REG63, 0x06);
	regmap_write(es8389->regmap, ES8389_LOW_POWER1_REG6B, 0x00);
	regmap_write(es8389->regmap, ES8389_MOD_SW2_REG70, 0x88);
	if (es8389->dmic)
		regmap_write(es8389->regmap, ES8389_DMIC_EN_REG6D, 0xFC);
	else
		regmap_write(es8389->regmap, ES8389_DMIC_EN_REG6D, 0x3C);
	regmap_write(es8389->regmap, ES8389_MIC1_GAIN_REG72, 0x50);
	regmap_write(es8389->regmap, ES8389_MIC2_GAIN_REG73, 0x00);
