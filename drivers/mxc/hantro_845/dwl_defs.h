...
#define HANTRODEC_DEC_BUS_ERROR	     BIT(13)
#define HANTRODEC_DEC_STRM_BUF_EMPTY BIT(14)
#define HANTRODEC_DEC_ASO_DETECTED   BIT(15)
#define HANTRODEC_DEC_STRM_INPUT_ERR BIT(16)
#define HANTRODEC_DEC_TIMEOUT        BIT(18)
#define HANTRODEC_DEC_JPEG_SLICE     BIT(17)

#define HANTRODEC_DEC_ERROR_MASK     (HANTRODEC_DEC_BUS_ERROR | \
				      HANTRODEC_DEC_STRM_BUF_EMPTY | \
				      HANTRODEC_DEC_ASO_DETECTED | \
				      HANTRODEC_DEC_STRM_INPUT_ERR)

#define HANTRODEC_DEC_END_MASK       (HANTRODEC_DEC_DONE | \
				      HANTRODEC_DEC_ERROR_MASK | \
				      HANTRODEC_DEC_JPEG_SLICE)
